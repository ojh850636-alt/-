python -m uvicorn lucia_ultimate_quantum_integrated_fixed:app --host 127.0.0.1 --port 8002 # Run pytest against the local running server (expects server at :8002)
