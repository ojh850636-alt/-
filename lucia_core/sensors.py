...
class RealitySensorSimulator:
    ...
    def generate(self):
        data = {"temperature": random.uniform(15, 110), "timestamp": datetime.now(timezone.utc).isoformat()}
    ...
    def vectorize(self, data):
        ...
        return [mapping.get(data.get('cctv_intrusion', '정상'), 0), mapping.get(data.get('network', '정상'), 0), data['temperature'] / 110.0]
